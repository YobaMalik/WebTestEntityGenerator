...
public class EntityManagerFactoryConfig {
    ...
    @Autowired
    public EntityManagerFactoryConfig(Environment env){
        this.env = env;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("MyProject.WebTestEntityGenerator.db.entity");
...
//xml persistence below
    ...
    public LocalEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPersistenceUnitName("MyFilesTest");
